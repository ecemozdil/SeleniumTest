...
import com.thoughtworks.selenium.webdriven.commands.WaitForPageToLoad;
	...
	public class SeleniumTest {
	  ...
	  public void testN11Selenium() throws Exception {
	    ...
	    int authorcount = driver.findElements(By.xpath("//body/div[@id='wrapper']/div[@id='contentWrapper']/div[@class='container']/div[@id='content']/div[@id='authorsList']/div/ul/li")).size();
	    ...
	    if(authorcount <= 80)
	    {
		    ...
		    int authorcount2 = driver.findElements(By.xpath("//body/div[@id='wrapper']/div[@id='contentWrapper']/div[@class='container']/div[@id='content']/div[@id='authorsList']/div/ul/li")).size();
